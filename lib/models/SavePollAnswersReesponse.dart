class Savepollanswersreesponse {
  bool? success;
  int? code;
  String? message;
  EducationData? data;

  Savepollanswersreesponse({this.success, this.code, this.message, this.data});

  Savepollanswersreesponse.fromJson(Map<String, dynamic> json) {
