...
class _BasicProfileTab extends State<HouseHoldTab>
    ...
    with SingleTickerProviderStateMixin
{
        ...
        child: Column(
          ...
          children: [
            _buildConsentText(
              ...
              'I consent to providing information about Religion and under... ',
              onMorePressed: () {},
            ...
            Row(
              ...
              children: [
                ...
                sectionTitle('What religion do you practice?',height),
 ...
 ,
  ...
  Widget _buildConsentText(  double height, String text, {VoidCallback? onMorePressed}) {
    return RichText(
      text: TextSpan(
       // style: TextStyle(color: Colors.black, fontSize: 14),


        style:  AppTextStyles.normalopenSans(AppColor.blackColor,height*.29),
