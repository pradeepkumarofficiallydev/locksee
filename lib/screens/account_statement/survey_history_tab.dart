...
class SurveyHistoryTab extends StatefulWidget {
  @override
  _BasicProfileTab createState() => _BasicProfileTab();
}

class _BasicProfileTab extends State<SurveyHistoryTab>
  ...
  Future<void> _selectDate(BuildContext context, bool isStartDate) async {
    ...
    controller.pointsAllListDataFun(
            ...
            children: [
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              ...
                              _selectedListingCultureId = s.queryTypes.firstWhere(
                                    (query) => query['value'] == newValue,
                                orElse: () => {"id": 0}, // Provide a default map with id = 0
                              )['id'];
                              ...
                              s.SurveyHistoryListDataFun(_selectedListingCultureId!, 0, "", "");
                            });
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      (s.pointsAllListDataResponse.value.data?.totalcount !=
                                  null) &&
                              (s.pointsAllListDataResponse.value.data!
                                          .totalcount ??
                                      0) >
                                  0
                          ? Row(
                          ...
                          : Container(
                              child: Expanded(
                                child: ListView.builder(
                                  ...
                                  itemCount: s.pointsAllListDataResponse.value
