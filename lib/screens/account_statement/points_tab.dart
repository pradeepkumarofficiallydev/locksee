...
class _BasicProfileTab extends State<PointsTab>
  ...
  void initState() {
   ...
   // controller.pointsAllListDataFun(0, 0, "", "");
  ...
  Future<void> _selectDate(BuildContext context, bool isStartDate) async {
    ...
    DateTime lastDate = DateTime(initialDate.year, initialDate.month, initialDate.day, 23, 59, 59);
    ...
    controller.pointsAllListDataFun(_selectedListingCultureId!, 0 ,'${startDate?.year}-${startDate?.month}-${startDate?.day}',   '${endDate?.year}-${endDate?.month}-${endDate?.day}');
            ...
            children: [
              Row(
                ...
                children: [
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              ...
                              //     .pointsTagsResponse.value.data?.data
                              //     ?.firstWhere((survey) =>
                              // survey.options == newValue)
                              //     .listingCultureId;
                              //
                              // print("category ${_selectedListingCultureId}");




                              _selectedListingCultureId = s.pointsTagsResponse.value.data?.data
                                  ?.firstWhere(
                                    (survey) => survey.options== newValue,
                                orElse: () => DataItem(listingCultureId: 0), // Provide a default object
                              ).id;

                              print("categoryss $_selectedListingCultureId");




                              s.pointsAllListDataFun(_selectedListingCultureId!, 0 ,"","");});
                          ...
                          // ["Tag 1", "Tag 2", "Tag 3"].
                          s.points_tags_list.map((String tag) {
                  ...
                  Expanded(
                      child: _buildDatePicker(context, startDate, true, "Form", height)),
                  SizedBox(width: height * .2),
                  Expanded(
                      child: _buildDatePicker(context, endDate, false, "To", height)),
                ],
              ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      (s.pointsAllListDataResponse.value.data?.totalcount!=null) && (s.pointsAllListDataResponse.value.data!.totalcount??0) > 0
                      ...
                      s.isLoading1.value
                        ...
                        child: Expanded(
                          child: ListView.builder(
                            ...
                            itemCount: s.pointsAllListDataResponse
                                .value.data?.finalData?.length ??
                                0,
                            itemBuilder: (context, index) {
                              final rewardsInstance = s
                                  .pointsAllListDataResponse
                                  .value
                                  .data
                                  ?.finalData![index];
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${rewardsInstance?.pointEarned.toString() ?? ""}',
                                          ...
                                          Text(
                                            ...
                                            s.formatCustomDate('${rewardsInstance?.createdOn.toString() ?? ""}'),


                                           // '${rewardsInstance?.createdOn.toString() ?? ""}',
